              ...
              <div class="row">
                <div class="col-6">
                  <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" method="POST" action="../coreScripts/addCategory.php">
                      <div class="card-body">
                        <div class="form-group">
                          <label for="exampleInputEmail1">
                            نام دسته بندی
                          </label>
                          <input type="text" name="categoryName" class="form-control" id="exampleInputEmail1" placeholder="نام دسته بندی را وارد کنید" />
                        </div>
                      </div>
                      <!-- /.card-body -->
                        ...
                        <tbody>
                          ...
                          while ($row = $result->fetch_assoc()) {
                            ...
                            <tr>
                              ...
                              <td>
                                <?php
                                echo '<a href="../coreScripts/deleteCategory.php?categoryName=' . $row["categoryName"] . '" class="btn btn-danger">حذف</a>'
                                ?>
                              </td>
                            </tr>
                          <?php
