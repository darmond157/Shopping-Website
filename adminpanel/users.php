...
if ($_POST) {
    ...
    $strFormat = substr($strFormat, 0, strlen($strFormat) - 5);

    $username = $_POST["username"];
    $phone = $_POST["phone"];
    $command = "select * from users where(" . $strFormat . ")";
    $stmt = $conn->prepare($command);
    $stmt->bind_param($strFilter, ...$data);
    $stmt->execute();
    $result = $stmt->get_result();
}
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php
                                                                if ($row['status'] == "active") {
                                                                    ...
                                                                    echo '<span class="badge badge-danger">مسدود</span>';
                                                                }
                                                                ?></td>
                                                            <td>
                                                                <?php
                                                                ...
                                                                <?php
                                                                if ($row["status"] == "active") {
                                                                    echo '<a class="btn btn-warning" href="../coreScripts/changeUserStatus.php?username=' . $row["username"] . '&status=deactive">مسدود</a>';
                                                                } else {
                                                                    echo '<a class="btn btn-success" href="../coreScripts/changeUserStatus.php?username=' . $row["username"] . '&status=active">فعال</a>';
                                                                }
                                                                ?>
                                                            </td>
                                                        </tr>
