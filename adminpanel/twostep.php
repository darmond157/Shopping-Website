...
<html>
  <head>
    ...
    <title>پنل مدیریت | ورود دو مرحله ای</title>
              ...
              >
                ...
                <li class="nav-item has-treeview menu-open">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="twostep.php" class="nav-link active">
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 text-dark">ورود دو مرحله ای</h1>
              </div>
              <!-- /.col -->
              <div class="col-sm-6">
                  ...
                  <div class="col-6">
                    <div class="card card-primary">
                      <div class="card-header">
                        <h3 class="card-title">فرم تنظیمات ورود دو مرحله ای</h3>
                      </div>
                      <!-- /.card-header -->
                      <!-- form start -->
                      <form role="form">
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            <label for="exampleInputEmail1">نوع two step</label>
